...
- [ ] Returns flag when ≥ 3 contracts from same agency in same month all below threshold with combined value above threshold
- [ ] Returns empty when contracts span different months or agencies
- [ ] Partition filters `ano` present; no full-table scan
